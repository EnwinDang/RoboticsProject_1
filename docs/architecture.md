...
5. Poses are published event-driven (ADD / UPDATE / REMOVE) via ROS2 and MQTT.
...
A top-down snapshot is uploaded every minute via FTP when localisation is stopped.
